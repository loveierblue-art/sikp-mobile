...
class _DaftarBimbinganPageState extends State<DaftarBimbinganPage> {
  final FirebaseFirestore _firestore =
      FirebaseFirestore.instance; //jembatan ke db cloud firestore
          ...
          (context) => Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildMemberTile(data['nama'], data['npm']),
                if (data['namaPartner'] != null && data['namaPartner'] != '')
                  _buildMemberTile(data['namaPartner'], data['npmPartner']),
              ],
            ),
          ),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        //pakai Stack biar hiasan lingkaran bisa numpuk di belakang
        children: [
          Positioned(
            top: -50,
            right: -50,
                ...
                child:
                    _isLoading
                        ...
                        : StreamBuilder<QuerySnapshot>(
                          //data berubah di Firestore, aplikasi otomatis update
                          stream:
                              _firestore
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final String npm1 = data['npm'] ?? '-';
                                final String nama2 = data['namaPartner'] ?? '';
                                final String npm2 = data['npmPartner'] ?? '';
                                final String instansi = data['instansi'] ?? '-';

                                return InkWell(
                                  onTap:
                                      () => _showDetailPengajuan(context, data),
