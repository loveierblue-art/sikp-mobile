                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                      ...
                      color: Color(0xFF1B3F0D),
                    ),
                  ),
                  const SizedBox(height: 10),
                  const Text(
                    'Pengajuan KP Anda berhasil dikirim.',
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color:
                        selectedDate == null
                            ? const Color(0xFF86A87A)
                            : const Color(0xFF1B3F0D),
                  ),
                ),
                const Spacer(),
                const Icon(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    const Color(0xFF337418).withOpacity(0.3),
                    Colors.transparent,
                  ],
                ),
              ),
