                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Tentukan Jadwal Baru', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1B5E20))),
                      const SizedBox(height: 20),
  ...
  Widget _buildTextField(TextEditingController controller, String label, IconData icon, {bool readOnly = false, VoidCallback? onTap}) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF1B5E20))),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: const Color(0xFF337418).withOpacity(0.1))),
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFF337418))),
            ),
          ),
        ],
      ),
          ...
          Column(
            children: [
              ...
              Container(
                width: double.infinity,
                decoration: const BoxDecoration(
                  gradient: LinearGradient(colors: [Color(0xFF1B5E20), Color(0xFF337418)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                ...
                child: Column(
                  children: [
                    ...
                    const Text('Kelola Jadwal', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                    const Text('Atur agenda bimbingan dengan mahasiswa', style: TextStyle(fontSize: 13, color: Colors.white70)),
                  ],
                ),
              ),
